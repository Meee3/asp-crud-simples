...
namespace Emprestimos01.Controllers
{
    public class EmprestimosController : Controller
    {
        ...
        public EmprestimosController(Emprestimos01Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("EmprestimoId,valorSolicitado,valorEntrada")] Emprestimos emprestimos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmprestimoId,valorSolicitado,valorEntrada")] Emprestimos emprestimos)
        {

...
namespace Cinema3.Controllers
{
    public class FilmesController : Controller
    {
        ...
        public FilmesController(Cinema3Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("FilmeId,Nome")] Filme filme)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FilmeId,Nome")] Filme filme)
        {
            if (id != filme.FilmeId)
            {
                return NotFound();

...
namespace Cinema3.Controllers
{
    public class SalasController : Controller
    {
        ...
        public SalasController(Cinema3Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("SalaId,quantidadeAssentos")] Sala sala)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SalaId,quantidadeAssentos")] Sala sala)
        {
            if (id != sala.SalaId)
            {
                return NotFound();
